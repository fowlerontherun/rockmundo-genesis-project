...
BEGIN
 ...
 IF position('TG_OP' IN definition)=0 OR position('expected_line_version' IN definition)=0 OR position('festival_payment_resolution_evidence_required' IN definition)=0 THEN RAISE EXCEPTION 'terminal trigger is unsafe or unaudited'; END IF;
