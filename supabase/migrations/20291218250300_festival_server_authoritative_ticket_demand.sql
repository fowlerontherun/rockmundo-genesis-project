-- Simplified Festival ticketing: the owner chooses price and availability.
-- Sell-through is game-owned and reacts to price, marketing, reputation and active upgrades.
...
BEGIN
  ...
  -- Ignore any client-provided expectedSellThroughBasisPoints.
...
-- Existing open annual editions should use the same demand model immediately,
