-- Preserve the pre-completion pending quantity so notifications report the
-- actual number of units delivered instead of 0 after pending_quantity resets.
...
begin
  with candidates as materialized (
    ...
    set stock_quantity = coalesce(pm.stock_quantity, 0) + c.completed_quantity,
        pending_quantity = 0,
