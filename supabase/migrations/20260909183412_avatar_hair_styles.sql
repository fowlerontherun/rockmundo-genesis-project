-- Add optional hair selections without rewriting existing appearances.
-- Six free starter designs per clothing slot; existing IDs and owner policies remain valid.
...
begin
  ...
  if obj ? 'hairStyle' and not coalesce(obj->>'hairStyle' = any(array['original','bald','buzz','quiff','mohawk','bob','ponytail','bun','curls','long']), false) then return false; end if;
