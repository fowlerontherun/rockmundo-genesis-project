...
-- Schedule housing market price updates every 4 hours
SELECT cron.schedule(
  'update-housing-market-prices',
  '0 */4 * * *',
  $$
  SELECT net.http_post(
    url := 'https://yztogmdixmchsmimtent.supabase.co/functions/v1/update-housing-market',
