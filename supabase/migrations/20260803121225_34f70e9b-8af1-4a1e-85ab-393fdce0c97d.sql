...
BEGIN
  ...
  v_score := greatest(
    ...
    least(
      ...
      round(
        45
        + least(25, coalesce(v_band.chemistry_level, 50)::numeric * 0.25)
  ...
  v_multiplier := 0.5 + (v_score::numeric / 100) * 0.9;
  ...
  v_critic    := greatest(1, least(100, v_score + round(random() * 10 - 5)::integer));
