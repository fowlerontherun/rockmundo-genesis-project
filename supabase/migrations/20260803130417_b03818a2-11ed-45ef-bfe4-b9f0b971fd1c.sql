...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.festival_operation_migration_issues TO authenticated;
GRANT ALL ON public.festival_operation_migration_issues TO service_role;
