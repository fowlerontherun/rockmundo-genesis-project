-- Canonical festival performance sessions and readiness layer.
-- Additive migration after festival booking workspaces.
...
DECLARE s public.festival_performance_sessions%ROWTYPE; total integer; nextpos integer; ev text;
BEGIN
 SELECT * INTO s FROM public.festival_performance_sessions WHERE id=p_session_id FOR UPDATE;
