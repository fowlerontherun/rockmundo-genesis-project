...
begin
  ...
  values(p_gig_id,o.id,'gig-commerce-v2','{}') returning * into s;
  ...
  snapshot:=jsonb_build_object('formulaVersion','gig-commerce-v2','settlementId',s.id,
