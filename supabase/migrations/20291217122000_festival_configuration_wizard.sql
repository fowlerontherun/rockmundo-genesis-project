-- Festival configuration wizard. Browser access is RPC-only; tables deliberately have no player policies.
...
ALTER TABLE public.festival_scale_catalogue ENABLE ROW LEVEL SECURITY; ALTER TABLE public.festival_configurations ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.festival_configuration_requests ENABLE ROW LEVEL SECURITY; ALTER TABLE public.festival_configuration_audit ENABLE ROW LEVEL SECURITY;
...
REVOKE ALL ON FUNCTION public.get_festival_configuration(uuid) FROM PUBLIC,anon; REVOKE ALL ON FUNCTION public.save_festival_configuration(uuid,integer,jsonb,uuid) FROM PUBLIC,anon;
