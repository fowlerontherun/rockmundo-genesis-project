-- Keep tour ownership aligned with tours.user_id, which references auth.users(id).
-- The active character profile remains available for character-scoped booking work.
