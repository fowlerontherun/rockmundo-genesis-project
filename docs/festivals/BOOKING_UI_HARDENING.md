...
## Booking workspace completion follow-up

The post-PR #1196 completion pass adds server-backed represented-band, eligibility, invitation-candidate, slot, repertoire and setlist-preflight projections. The player and organiser UI should consume those projections through booking query keys instead of placeholder eligibility, raw song UUID fields or caller-supplied authority.
