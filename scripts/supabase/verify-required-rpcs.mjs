...
const requiredRpcs = [
  ...
  ...['get_festival_crowd_runtime','get_festival_incident_dashboard','get_festival_operational_outcomes','get_festival_vendor_sales','get_festival_sponsor_activation_runtime','get_public_festival_live_experience','recalculate_festival_crowds','acknowledge_festival_incident','assign_festival_incident_response','resolve_festival_incident','escalate_festival_incident','close_festival_stage_for_incident','reopen_festival_stage_after_incident','start_festival_sponsor_activation','complete_festival_sponsor_activation','close_festival_vendor_sales','finalise_festival_runtime_outcomes'].map((name) => ({ name, arguments: [] })),
  ...['get_festival_results','get_festival_result_detail','get_festival_history','get_festival_awards','get_festival_records','get_festival_statistics','get_festival_hall_of_fame','generate_festival_result','process_festival_legacy_generation_jobs','refresh_festival_world_records','generate_festival_season_awards','process_festival_legacy_publications'].map((name) => ({ name, arguments: [] })),
  ...['get_festival_settlement','get_festival_settlement_summary','get_festival_settlement_lines','get_my_festival_artist_statement','get_my_festival_staff_statement','get_my_festival_supplier_statement','get_my_festival_sponsor_statement','prepare_festival_settlement','execute_festival_settlement','retry_festival_settlement','retry_festival_settlement_line','resolve_festival_settlement_dispute'].map((name) => ({ name, arguments: [] })),
];
