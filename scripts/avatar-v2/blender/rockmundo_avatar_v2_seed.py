...
3. Generate the RockMundo skeleton guide with
   ...
   fit EarAnchor.L/EarAnchor.R to the real earlobe/piercing points and leave them
   parented to Head as non-deforming attachment markers.
...
5. Author separate iris/sclera/cornea surfaces for each eye and bind them to
   ...
   and copy the matching blink deformation. Assign a used RMV2_Lips material region
   to the skinned head/face. Split upper/lower teeth, bind upper teeth/mouth interior
