...
export const PortfolioSummary = ({
 ...
 <p className="text-xs tracking-wide text-muted-foreground">Net Worth</p>
 ...
 <div className="space-y-1 rounded-lg border border-muted/40 bg-muted/10 p-4">
 <p className="text-xs tracking-wide text-muted-foreground">Invested Capital</p>
 ...
 <div className="space-y-1 rounded-lg border border-muted/40 bg-muted/10 p-4">
 <p className="text-xs tracking-wide text-muted-foreground">Cash Reserve</p>
 ...
 <div className="space-y-1 rounded-lg border border-muted/40 bg-muted/10 p-4">
 <p className="text-xs tracking-wide text-muted-foreground">Monthly Net Flow</p>
