...
export function TravelProgressOverlay({
 ...
 <p className="text-[10px] text-muted-foreground tracking-wide">Time Left</p>
 <p className="text-base font-bold font-mono">{timeRemaining}</p>
 </div>
 <div className="p-3 rounded-lg bg-muted/50">
 <MapPin className="h-4 w-4 mx-auto mb-1 text-muted-foreground"/>
 <p className="text-[10px] text-muted-foreground tracking-wide">Arrival</p>
 <p className="text-base font-bold">{format(arrivalTime,"HH:mm")}</p>
 </div>
 <div className="p-3 rounded-lg bg-muted/50">
 <Gauge className="h-4 w-4 mx-auto mb-1 text-muted-foreground"/>
 <p className="text-[10px] text-muted-foreground tracking-wide">Cruise Speed</p>
 ...
 <p className="text-[10px] text-muted-foreground tracking-wide">~ Distance</p>
 ...
 <Button
 key={activity.path}
 variant="outline"className="w-full justify-start gap-3 h-auto py-3"onClick={() => navigate(activity.path)}
 >
 ...
 {canCancel && onCancel && (
 <Button
 variant="destructive"className="w-full"onClick={onCancel}
 >
