...
export const EventLineupPlanner = ({ lineup, onLineupChange }: EventLineupPlannerProps) => {
 ...
 <div className="rounded-lg border p-3">
 <p className="text-xs text-muted-foreground">Stage coverage score</p>
 ...
 <Input
 id="start-time"type="time"value={form.startTime}
 ...
 <Input
 id="end-time"type="time"value={form.endTime}
 ...
 placeholder="Highlight special guests, transitions, or production cues."rows={3}
 />
 </div>
