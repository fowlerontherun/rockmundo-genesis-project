...
export const EventSponsorManager = ({ sponsors, onSponsorsChange }: EventSponsorManagerProps) => {
 ...
 <Input
 id="sponsor-name"value={form.name}
 ...
 <Input
 id="contribution"type="number"min={0}
 ...
 <Textarea
 id="benefits"value={form.benefits}
 onChange={(event) => setForm((prev) => ({ ...prev, benefits: event.target.value }))}
 placeholder="Hospitality, stage naming, digital content rights, etc."rows={3}
 />
 </div>
 <div className="space-y-2">
 <Label htmlFor="activation-focus">Activation focus</Label>
 <Input
 id="activation-focus"value={form.activationFocus}
 ...
 <Input
 id="roi-goal"value={form.roiGoal}
 ...
 <div className="rounded-lg border p-4">
 <p className="text-xs text-muted-foreground">Projected partner ROI</p>
 ...
 <div className="rounded-lg border p-4">
 <p className="text-xs text-muted-foreground">Experience readiness</p>
 <p className="text-sm text-muted-foreground">
