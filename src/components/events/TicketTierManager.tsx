...
export const TicketTierManager = ({ eventId, onTiersChange }: TicketTierManagerProps) => {
 ...
 <Input
 id="tier-price"type="number"min={0}
 value={form.price}
 ...
 <Input
 id="tier-quantity"type="number"min={0}
 value={form.quantity}
 ...
 <Input
 id="tier-sold"type="number"min={0}
 ...
 <Input
 id="tier-fees"type="number"min={0}
 value={form.fees ?? 0}
 ...
 <Textarea
 id="tier-benefits"value={form.benefits ??""}
 onChange={(event) => setForm((prev) => ({ ...prev, benefits: event.target.value }))}
 placeholder="Fast lane entry, backstage tour, dedicated concierge"rows={3}
 />
 </div>
