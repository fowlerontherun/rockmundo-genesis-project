...
export const EventPricingStrategy = ({
 ...
 <p className="text-xs text-muted-foreground">Projected ticket revenue</p>
 ...
 <Input
 id="base-price"type="number"min={0}
 ...
 <Input
 id="break-even"type="number"min={0}
 ...
 <Input
 id="marketing"type="number"min={0}
 ...
 <Input
 id="demand-score"type="number"min={0}
 max={100}
