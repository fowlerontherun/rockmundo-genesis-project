...
export const GearComparisonDrawer = ({
 ...
 <div className="text-xs text-muted-foreground">Budget check</div>
 ...
 <div className="rounded-md border bg-muted/30 p-3">
 <div className="text-xs text-muted-foreground">Category depth</div>
