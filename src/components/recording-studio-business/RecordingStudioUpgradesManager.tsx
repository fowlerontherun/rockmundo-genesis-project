...
import { useRecordingStudioUpgrades, useInstallRecordingStudioUpgrade } from "@/hooks/useRecordingStudioBusiness";
import { STUDIO_UPGRADE_TYPES } from "@/types/recording-studio-business";

interface RecordingStudioUpgradesManagerProps {
  studioId: string;
}
...
export function RecordingStudioUpgradesManager({ studioId }: RecordingStudioUpgradesManagerProps) {
  ...
  const installUpgrade = useInstallRecordingStudioUpgrade();
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-sm">Install upgrades to attract top artists</p>
          </div>
        )}
      </CardContent>
    </Card>
