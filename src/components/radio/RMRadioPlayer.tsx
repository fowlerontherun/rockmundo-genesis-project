...
export const RMRadioPlayer = ({ open, onOpenChange }: RMRadioPlayerProps) => {
 ...
 <Button
 size="icon"variant="ghost"onClick={radio.reshufflePlaylist}
 title="Shuffle playlist">
 <Shuffle className="h-5 w-5"/>
 </Button>

 <Button
 size="icon"variant="default"className="h-12 w-12"onClick={radio.togglePlay}
 ...
 <Button
 size="icon"variant="ghost"onClick={radio.playNext}
 title="Next song">
 ...
 <Button
 size="icon"variant="ghost"className="h-8 w-8"onClick={() => radio.setMuted(!state.isMuted)}
 >
...
export const RMRadioButton = ({ className }: RMRadioButtonProps) => {
 ...
 <>
 <Button
 variant="ghost"size="sm"onClick={() => setOpen(true)}
 title="RM Radio"className={cn("relative gap-1.5 h-7 px-2", className)}
 >
