...
function BehaviorCard({
 ...
 return (
 <Card
 className={cn("relative transition-all duration-200 cursor-pointer border-2",
 isSelected
 ?"border-primary bg-primary/5 shadow-md": isLocked
 ?"border-muted opacity-60 cursor-not-allowed":"border-border hover:border-primary/50 hover:shadow-sm")}
 ...
 <CollapsibleTrigger
 className="flex items-center gap-1 text-xs text-muted-foreground mt-2 hover:text-foreground transition-colors"onClick={(e) => e.stopPropagation()}
 >
