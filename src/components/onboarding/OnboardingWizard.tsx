...
export const OnboardingWizard = () => {
  ...
  // Track whether we've hydrated from profile/identity so returning-player wizard
  // values (display name, username, backstory) are not clobbered by empty defaults.
  ...
  // Hydrate name + bio from the profile once (values set by the returning-player
  // wizard live on the profile row, not on the identity row).
  useEffect(() => {
