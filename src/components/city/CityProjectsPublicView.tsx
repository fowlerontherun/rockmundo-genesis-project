...
export function CityProjectsPublicView({ cityId }: { cityId: string }) {
 ...
 <div className="text-xs text-muted-foreground tracking-wide">In Progress</div>
 {active.map(p => {
 ...
 <div className="text-xs text-muted-foreground tracking-wide">Recently Completed</div>
 {completed.map(p => (
