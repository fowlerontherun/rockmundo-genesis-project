...
import type { OpenMicPerformance, OpenMicSongPerformance } from "@/hooks/useOpenMicNights";

interface OpenMicOutcomeReportProps {
  performance: OpenMicPerformance;
  songPerformances: OpenMicSongPerformance[];
}
...
export function OpenMicOutcomeReport({ performance, songPerformances }: OpenMicOutcomeReportProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Fame & Fans Earned - The main rewards */}
      ...
      <Card className="border-muted bg-muted/30">
        <CardContent className="py-4">
          <div className="flex items-center gap-3 text-muted-foreground">
            ...
            <p className="text-sm">
              Open mics don't pay, but the exposure is worth it! Keep building your fanbase.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {songPerformances.map((sp, index) => {
            ...
            const song = index === 0 ? performance.song_1 : performance.song_2;
            ...
            return (
              <div key={sp.id} className="space-y-2">
                ...
                {sp.commentary && sp.commentary.length > 0 && (
                  <div className="pl-4 border-l-2 border-muted">
                    {sp.commentary.map((comment, i) => (
      ...
      <div className="flex justify-center">
        <Button onClick={() => navigate('/open-mic')} className="gap-2">
          Find More Open Mics
