...
export const NPCDialoguePanel = ({
 ...
 <Button
 key={choice.id}
 variant="outline"size="sm"className="w-full justify-start text-left h-auto py-3 whitespace-normal"disabled={busy}
 onClick={() =>
 ...
 <Button
 variant="default"className="w-full"disabled={busy}
