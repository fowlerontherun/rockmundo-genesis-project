...
function FamilyMemberCard({ member }: { member: FamilyMember }) {
 ...
 className={cn("rounded-lg border-2 p-3 space-y-2 transition-all hover:scale-[1.02]",
 colorClass,
 ...
 label=""color={member.emotionalStability >= 50 ?"social-loyalty":"social-tension"}
...
export function FamilyLegacyPanel({
 ...
 label=""color={legacyPressure > 60 ?"social-tension":"social-trust"}
 size="sm"showValue={false}
 />
 ...
 <h4 className="text-xs font-semibold text-muted-foreground">Parents</h4>
 ...
 {/* Self + Partner Row */}
 <div className="space-y-1">
 <h4 className="text-xs font-semibold text-muted-foreground">You & Partner</h4>
 <div className="grid grid-cols-2 gap-2">
 ...
 {siblings.length > 0 && (
 <div className="space-y-1">
 <h4 className="text-xs font-semibold text-muted-foreground">Siblings</h4>
 <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
