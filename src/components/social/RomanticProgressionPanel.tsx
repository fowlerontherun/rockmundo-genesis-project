...
export function RomanticProgressionPanel({
 ...
 ?"border-social-drama/30 shadow-[0_0_20px_hsl(var(--social-drama)/0.15)]": romance.stage ==="married"|| romance.stage ==="engaged"?"border-social-love/30 shadow-love": romance.stage ==="separated"|| romance.stage ==="divorced"?"border-social-tension/30 shadow-tension-glow":"border-social-attraction/20";
 ...
 <h4 className="text-xs font-semibold text-muted-foreground">Stage Progression</h4>
 ...
 {i > 0 && (
 <div className={cn("w-4 h-px mx-0.5",
 isPast ?"bg-social-love":"bg-border",
 )} />
 )}
 <Tooltip>
 <TooltipTrigger asChild>
 <div className={cn("flex flex-col items-center gap-0.5 rounded-lg px-2 py-1.5 transition-all min-w-[52px]",
 ...
 label=""color={romance.affair_suspicion > 50 ?"social-tension":"social-jealousy"}
 size="sm"glowOnHigh
 />
 ...
 ?"border-social-love/30 bg-social-love/5":"border-border/50 bg-muted/20",
 )}>
 <div className="flex items-center justify-between">
 ...
 <Button
 size="sm"disabled={!advancement.canAdvance}
 ...
 <Button
 size="sm"onClick={() => setProposalOpen(true)}
 ...
 <h4 className="text-xs font-semibold text-muted-foreground">Unlocked</h4>
