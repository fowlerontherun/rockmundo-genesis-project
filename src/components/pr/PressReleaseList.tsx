...
export function PressReleaseList({ releases, isLoading }: PressReleaseListProps) {
 ...
 <EmptyState
 title="No press releases yet"description="Publish a release to share band news across your channels."icon={Megaphone}
 />
 ) : (
 <div className="space-y-3">
 ...
 <div
 key={release.id}
 className={cn("rounded-lg p-4 shadow-sm transition hover:shadow-md",
