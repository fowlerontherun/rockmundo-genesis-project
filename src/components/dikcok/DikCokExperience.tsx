...
const expansionFeatures: Array<{ title: string; description: string; tags: string[] }> = [
 ...
 description:"Pair any clip with an existing video using synchronized audio alignment, split layouts, and shared hype pools.",
 tags: ["Duets","Collaboration"],
 },
 {
 title:"Live Premieres",
 description:"Bands can schedule premiere windows with countdown overlays, exclusive templates, and spike forecasting dashboards.",
 tags: ["Events","Bands"],
 },
 {
 title:"Augmented Reality Filters",
 description:"Unlock branded AR personas, reactive lighting rigs, and motion-tracked effects tied to fan missions or purchases.",
 tags: ["AR","Creator Packs"],
 },
 {
 title:"Interactive Polls",
 description:"Embed tappable polls inside videos. Results feed into analytics and reward bonus hype when participation milestones hit.",
 tags: ["Engagement","Analytics"],
 },
 {
 title:"Story Chains",
 description:"Multi-episode narratives that pass from creator to creator, awarding guild streak bonuses for completion.",
 tags: ["Narrative","Guilds"],
 },
 {
 title:"Beat Challenges",
 description:"Tempo-aware rhythm mini-games layered on top of tracks. Viewers compete for leaderboards and tip boosts.",
 tags: ["Mini-game","Rhythm"],
 },
 {
 title:"Fan Missions",
 description:"Goal-driven quests from bands that unlock exclusive stems, merch, or cosmetic drops for participating fans.",
 tags: ["Community","Rewards"],
 },
 {
 title:"Creator Guilds",
 description:"Form teams with shared resource pools, research trees, and collaborative challenge objectives.",
 tags: ["Guilds","Social"],
 },
 {
 title:"Producer Mode",
 description:"Bands remix top-performing clips into official compilations with automated rights clearance and attribution.",
 tags: ["Bands","Remix"],
 },
 {
 title:"Hype Forecasting",
 description:"Predict trend trajectories, stake in-game currency, and earn analytics badges for accurate calls.",
 tags: ["Economy","Analytics"],
 },
 {
 title:"Virtual Concert Teasers",
 description:"Exclusive teaser templates with 3D stage previews, seat heatmaps, and cross-promotion hooks to ticket sales.",
 tags: ["Events","Marketing"],
 },
 {
 title:"Music Discovery Radio",
 description:"Auto-play carousel focused on tracks primed for content creation with one-tap Create buttons.",
 tags: ["Discovery","Audio"],
 },
 {
 title:"Behind-the-Scenes Clips",
 description:"Premium pass holders access private studio diaries, rehearsal breakdowns, and wellness routines.",
 tags: ["Premium","Lore"],
 },
 {
 title:"Cross-Game Challenges",
 description:"Link DikCok goals with gigs, busking, or touring for layered XP and cosmetic rewards.",
 tags: ["Cross-mode","Progression"],
 },
 {
 title:"Creator Education Hub",
 description:"Interactive lessons, mentor breakdowns, and practice templates for leveling up production quality.",
 tags: ["Education","Skills"],
 },
 {
 title:"Fan Remix Tools",
 description:"Lightweight DAW inside the uploader enabling tempo shifts, loop slicing, and one-touch mastering.",
 tags: ["Remix","Tools"],
 },
 {
 title:"Geo-Trends Map",
 description:"Heatmap overview of regional opportunities with recommendations on when and how to post.",
 tags: ["Analytics","Targeting"],
 },
 {
 title:"Sponsored Trends",
 description:"Branded takeovers with custom templates, product placements, and guaranteed placement budgets.",
 tags: ["Monetization","Events"],
 },
 {
 title:"AI-Powered Editing",
 description:"Machine learning identifies optimal cuts, transitions, and posting windows based on historical performance.",
 tags: ["AI","Editing"],
 },
 {
 title:"Archived Classics",
 description:"Library of legendary clips with remix permissions and historical analytics for inspiration.",
...
export const DikCokExperience = ({ profile }: DikCokExperienceProps) => {
 ...
 <Badge
 variant="secondary"className={cn("w-fit", fameTierColor[selectedBand?.fameTier ??"Silver"])}
 >
 ...
 className={cn("w-full px-4 py-3 text-left transition",
 ...
 className={cn("flex items-center justify-between rounded-md border px-3 py-2 text-left transition",
...
const ArchiveIcon = () => (
 <svg
 xmlns="http://www.w3.org/2000/svg"viewBox="0 0 24 24"fill="none"stroke="currentColor"strokeWidth="2"strokeLinecap="round"strokeLinejoin="round"className="h-5 w-5">
