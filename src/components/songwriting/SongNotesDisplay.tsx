...
export const SongNotesDisplay = ({
 ...
 const modeLabels: Record<string, string> = {'solo':'Solo Writing','topline':'Top-line Session','track-led':'Track-led Production','camp':'Writing Camp'};
 parts.push({ 
 ...
 <Textarea
 id="additional-notes"value={additionalNotes}
 onChange={(e) => onAdditionalNotesChange(e.target.value)}
 placeholder="Add production ideas, lyrical themes, reference tracks, or any other notes for this song..."className="min-h-20"disabled={disabled}
 />
