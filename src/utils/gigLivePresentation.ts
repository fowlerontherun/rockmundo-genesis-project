import type { StageScenery } from './gigStageScenery';
import { buildStageScenery } from './gigStageScenery';
...
export interface LiveGigPresentationState { scene: LivePresentationScene; intensity: number; crowdState: CrowdPresentationState; crowdDensity: number; venueTier: VenuePresentationTier; scenery: StageScenery; stageLayout: StageLayoutKey; lightingState: LightingPresentationState; productionState: string; performerStates: PerformerPresentationState[]; activeEffects: string[]; headline: string; commentary: string[]; currentSongProfile: { title: string; phase: string; genre: string; tempoLabel: string; moodLabel: string; isCrowdFavourite: boolean; performanceLabel: string; }; accessibilitySummary: string; }
