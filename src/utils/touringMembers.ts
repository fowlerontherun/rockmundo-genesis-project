import { BAND_PERFORMANCE_ROLES, BAND_VOCAL_ASSIGNMENTS } from '@/data/bandPerformanceRoles';
...
export const INSTRUMENT_ROLES = BAND_PERFORMANCE_ROLES;
export const VOCAL_ROLES = BAND_VOCAL_ASSIGNMENTS;
