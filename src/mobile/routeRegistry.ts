...
const me = [
  "/me/*", "/me", "/character/*", "/character", "/wellness", "/inventory", "/skills", "/education", "/avatar-designer", "/avatar-v2-preview", "/skin-store", "/clothing-designer", "/achievements", "/my-character/*", "/my-character", "/characters/*", "/characters", "/buy-character-slot", "/slot-purchase-success", "/underworld", "/legacy", "/family/*", "/journal", "/version-history", "/vip-*", "/premium-store", "/blind-boxes/*", "/blind-boxes", "/hall-of-immortals"
];
