...
export const FabMenu = () => {
  ...
  const base: Action[] = [
    { key: "practice", label: "Practice", icon: <Zap className="h-5 w-5" />, to: "/mobile/me/skills" },
    { key: "travel", label: "Travel", icon: <Plane className="h-5 w-5" />, to: "/mobile/world/travel" },
    { key: "write", label: "Write Song", icon: <PenLine className="h-5 w-5" />, to: "/mobile/career/songwriting" },
    ...
    { key: "book-studio", label: "Book Studio", icon: <Mic2 className="h-5 w-5" />, to: "/mobile/career/recording" },
    { key: "book-rehearsal", label: "Rehearsal", icon: <CalendarClock className="h-5 w-5" />, to: "/mobile/career/rehearsals" },
    { key: "twaater", label: "Twaater", icon: <Twitter className="h-5 w-5" />, to: "/mobile/social/twaater" },
    { key: "sleep", label: "Sleep", icon: <Moon className="h-5 w-5" />, to: "/mobile/me/wellness" },
    { key: "eat", label: "Eat", icon: <Utensils className="h-5 w-5" />, to: "/mobile/me/wellness" },
    { key: "shop", label: "Shop", icon: <ShoppingBag className="h-5 w-5" />, to: "/mobile/world/shops" },
