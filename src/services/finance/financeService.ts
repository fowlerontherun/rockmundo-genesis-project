...
export const financeService = {
  ...
  async credit(ownerType: FinanceOwnerType, ownerId: string, amount: number, category: FinanceTransactionCategory, description: string, idempotencyKey: string, createdByProfileId?: string) {
    return rpc<string>("finance_credit_owner", { p_owner_type: ownerType, p_owner_id: ownerId, p_amount_minor: toMinorUnits(amount), p_category: category, p_description: description, p_idempotency_key: idempotencyKey, p_created_by_profile_id: createdByProfileId ?? null, p_metadata: {} });
  },
  async debit(ownerType: FinanceOwnerType, ownerId: string, amount: number, category: FinanceTransactionCategory, description: string, idempotencyKey: string, createdByProfileId?: string) {
    return rpc<string>("finance_debit_owner", { p_owner_type: ownerType, p_owner_id: ownerId, p_amount_minor: toMinorUnits(amount), p_category: category, p_description: description, p_idempotency_key: idempotencyKey, p_created_by_profile_id: createdByProfileId ?? null, p_metadata: {} });
  },
