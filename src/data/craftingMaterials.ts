...
export const CRAFTING_RECIPES: CraftingRecipeSeed[] = [
  ...
  // === PEDAL RECIPES ===
  {
    name: "Basic Fuzz Pedal",
    result_category: "pedal",
    result_subcategory: "fuzz",
    required_skill_slug: "luthiery_basic_technical",
    min_skill_level: 1,
    materials_required: [
      { material_name: "Basic Enclosure", quantity: 1 },
      { material_name: "Silicon Transistor", quantity: 2 },
      { material_name: "Potentiometer Set", quantity: 1 },
      { material_name: "Footswitch", quantity: 1 },
      { material_name: "Resistor Kit", quantity: 1 },
      { material_name: "LED Indicator Set", quantity: 1 },
    ],
    base_craft_time_minutes: 30,
    difficulty_tier: 1,
    rarity_output: "common",
    description: "A simple silicon fuzz pedal with raw, buzzy gain.",
  },
  {
    name: "Classic Overdrive Pedal",
    result_category: "pedal",
    result_subcategory: "overdrive",
    required_skill_slug: "luthiery_basic_technical",
    min_skill_level: 2,
    materials_required: [
      { material_name: "Basic Enclosure", quantity: 1 },
      { material_name: "Op-Amp Chip", quantity: 1 },
      { material_name: "Potentiometer Set", quantity: 1 },
      { material_name: "Footswitch", quantity: 1 },
      { material_name: "Capacitor Kit", quantity: 1 },
      { material_name: "Resistor Kit", quantity: 1 },
      { material_name: "LED Indicator Set", quantity: 1 },
    ],
    base_craft_time_minutes: 45,
    difficulty_tier: 1,
    rarity_output: "common",
    description: "Smooth, tube-like overdrive based on classic TS circuits.",
  },
  {
    name: "Germanium Fuzz Face Clone",
    result_category: "pedal",
    result_subcategory: "fuzz",
    required_skill_slug: "luthiery_professional_technical",
    min_skill_level: 5,
    materials_required: [
      { material_name: "Hammond Enclosure", quantity: 1 },
      { material_name: "Germanium Transistor", quantity: 2 },
      { material_name: "Potentiometer Set", quantity: 1 },
      { material_name: "Footswitch", quantity: 1 },
      { material_name: "Capacitor Kit", quantity: 1 },
      { material_name: "Boutique PCB Board", quantity: 1 },
      { material_name: "Custom Pedal Artwork", quantity: 1 },
    ],
    base_craft_time_minutes: 90,
    difficulty_tier: 3,
    rarity_output: "rare",
    description: "Warm, vintage germanium fuzz with NOS transistors and boutique build quality.",
  },
  {
    name: "Analog Delay Pedal",
    result_category: "pedal",
    result_subcategory: "delay",
    required_skill_slug: "luthiery_professional_technical",
    min_skill_level: 6,
    materials_required: [
      { material_name: "Hammond Enclosure", quantity: 1 },
      { material_name: "BBD Delay Chip", quantity: 1 },
      { material_name: "Op-Amp Chip", quantity: 2 },
      { material_name: "Potentiometer Set", quantity: 1 },
      { material_name: "Footswitch", quantity: 1 },
      { material_name: "Capacitor Kit", quantity: 1 },
      { material_name: "Boutique PCB Board", quantity: 1 },
    ...
    difficulty_tier: 3,
    rarity_output: "rare",
    description: "Warm, dark analog delay with genuine BBD chip for lush repeats.",
  },
  {
    name: "Lo-Fi Delay Pedal",
    result_category: "pedal",
    result_subcategory: "delay",
    required_skill_slug: "luthiery_basic_technical",
    min_skill_level: 3,
    materials_required: [
      { material_name: "Basic Enclosure", quantity: 1 },
      { material_name: "PT2399 Digital Delay", quantity: 1 },
      { material_name: "Potentiometer Set", quantity: 1 },
      { material_name: "Footswitch", quantity: 1 },
      { material_name: "Capacitor Kit", quantity: 1 },
      { material_name: "Resistor Kit", quantity: 1 },
    ...
    difficulty_tier: 2,
    rarity_output: "uncommon",
    description: "Characterful digital delay with lo-fi degradation on long repeats.",
  },
  {
    name: "Boutique Tube Screamer",
    result_category: "pedal",
    result_subcategory: "overdrive",
    required_skill_slug: "luthiery_mastery_technical",
    min_skill_level: 8,
    materials_required: [
      { material_name: "Hammond Enclosure", quantity: 1 },
      { material_name: "Op-Amp Chip", quantity: 1 },
      { material_name: "NOS Mullard Tube", quantity: 1 },
      { material_name: "Potentiometer Set", quantity: 1 },
      { material_name: "Footswitch", quantity: 1 },
      { material_name: "Boutique PCB Board", quantity: 1 },
      { material_name: "Custom Pedal Artwork", quantity: 1 },
    ...
    difficulty_tier: 4,
    rarity_output: "epic",
    description: "Tube-hybrid overdrive with NOS Mullard tube for unmatched warmth and saturation.",
  },

  // === AMP RECIPES ===
  {
    name: "5W Practice Amp",
    result_category: "amp",
    result_subcategory: "combo",
    required_skill_slug: "luthiery_basic_technical",
    min_skill_level: 3,
    materials_required: [
      { material_name: "12AX7 Preamp Tube", quantity: 1 },
      { material_name: "EL84 Power Tube Pair", quantity: 1 },
      { material_name: "Power Transformer", quantity: 1 },
      { material_name: "Amp Chassis", quantity: 1 },
      { material_name: "Jensen Speaker 10\"", quantity: 1 },
      { material_name: "Turret Board", quantity: 1 },
      { material_name: "Tolex Covering", quantity: 1 },
      { material_name: "Wiring Harness", quantity: 1 },
    ],
    base_craft_time_minutes: 120,
    difficulty_tier: 2,
    rarity_output: "uncommon",
    description: "A low-wattage tube combo amp — perfect for bedroom tone chasers.",
  },
  {
    name: "British 30W Combo",
    result_category: "amp",
    result_subcategory: "combo",
    required_skill_slug: "luthiery_professional_technical",
    min_skill_level: 6,
    materials_required: [
      { material_name: "12AX7 Preamp Tube", quantity: 2 },
      { material_name: "EL34 Power Tube Pair", quantity: 1 },
      { material_name: "Vintage Output Transformer", quantity: 1 },
      { material_name: "Power Transformer", quantity: 1 },
      { material_name: "Amp Chassis", quantity: 1 },
      { material_name: "Celestion Speaker 12\"", quantity: 1 },
      { material_name: "Speaker Cabinet Shell", quantity: 1 },
      { material_name: "Turret Board", quantity: 1 },
      { material_name: "Amp Reverb Tank", quantity: 1 },
      { material_name: "Tolex Covering", quantity: 1 },
      { material_name: "Wiring Harness", quantity: 1 },
    ],
    base_craft_time_minutes: 200,
    difficulty_tier: 3,
    rarity_output: "rare",
    description: "A hand-wired British-voiced combo with rich harmonics and spring reverb.",
  },
  {
    name: "American Clean 40W Head",
    result_category: "amp",
    result_subcategory: "head",
    required_skill_slug: "luthiery_professional_technical",
    min_skill_level: 7,
    materials_required: [
      { material_name: "12AX7 Preamp Tube", quantity: 3 },
      { material_name: "6L6 Power Tube Pair", quantity: 2 },
      { material_name: "Vintage Output Transformer", quantity: 1 },
      { material_name: "Power Transformer", quantity: 1 },
      { material_name: "Amp Chassis", quantity: 1 },
      { material_name: "Turret Board", quantity: 1 },
    ...
    base_craft_time_minutes: 220,
    difficulty_tier: 4,
    rarity_output: "epic",
    description: "A pristine American clean amp head with lush spring reverb and headroom for days.",
  },
  {
    name: "Masterwork Plexi 100W",
    result_category: "amp",
    result_subcategory: "head",
    required_skill_slug: "luthiery_mastery_technical",
    min_skill_level: 10,
    materials_required: [
      { material_name: "NOS Telefunken 12AX7", quantity: 3 },
      { material_name: "EL34 Power Tube Pair", quantity: 2 },
      { material_name: "Mercury Magnetics OT", quantity: 1 },
      { material_name: "Power Transformer", quantity: 1 },
      { material_name: "Amp Chassis", quantity: 1 },
      { material_name: "Turret Board", quantity: 1 },
      { material_name: "Tolex Covering", quantity: 1 },
    ...
    difficulty_tier: 5,
    rarity_output: "legendary",
    description: "A legendary hand-wired Plexi-style amp with NOS Telefunken tubes and boutique transformers.",
  },
  {
    name: "4x12 Speaker Cabinet",
    result_category: "amp",
    result_subcategory: "cabinet",
    required_skill_slug: "luthiery_basic_technical",
    min_skill_level: 4,
    materials_required: [
      { material_name: "Speaker Cabinet Shell", quantity: 1 },
      { material_name: "Celestion Speaker 12\"", quantity: 4 },
      { material_name: "Tolex Covering", quantity: 2 },
      { material_name: "Wiring Harness", quantity: 1 },
    ],
    base_craft_time_minutes: 90,
    difficulty_tier: 2,
    rarity_output: "uncommon",
    description: "A full-size 4x12 speaker cabinet loaded with Celestion speakers.",
  },
];
