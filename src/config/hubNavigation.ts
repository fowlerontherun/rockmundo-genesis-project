...
export const worldHubNavigation: HubNavigationItem[] = [
  ...
  { id: "companies", label: "Companies", path: "/world/companies", icon: Briefcase, matchPaths: ["/world-companies", "/companies/directory"] },
...
export const bandHubNavigation: HubNavigationItem[] = [
  ...
  { id: "equipment", label: "Band Equipment", path: "/stage-equipment", icon: Package, matchPaths: ["/stage-setup", "/stage-equipment"] },
  { id: "crew", label: "Show Crew", path: "/band-crew", icon: Users },
