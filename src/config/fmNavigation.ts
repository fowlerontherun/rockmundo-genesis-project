...
export const FM_MODULES: FMModule[] = [
  ...
  // 4. BAND & LIVE — merged
  {
    ...
    subTabs: [
      ...
      { label: "Festivals", path: "/festival-opportunities", icon: Trophy },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Festival Opportunities", path: "/festival-opportunities", icon: Trophy },
          { label: "Festival Directory", path: "/world/festivals", icon: Calendar },
  ...
  // 7. WORLD — places, travel, politics
  {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { label: "Companies", path: "/world/companies", icon: Building2 },
          { label: "Festivals", path: "/world/festivals", icon: Calendar },
          { label: "Found a Festival", path: "/festival-company/new", icon: Star },
    ...
    quickActions: [
      { label: "Travel Somewhere", path: "/world/travel", icon: Plane, description: "Move between cities" },
      { label: "Explore Cities", path: "/world/cities", icon: MapPin },
