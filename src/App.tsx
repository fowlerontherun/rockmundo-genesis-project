...
const TotpRenderFrame = lazyWithRetry(() => import("./pages/internal/TotpRenderFrame"));
...
const PropertyHub = lazyWithRetry(() => import("./pages/PropertyHub"));
            ...
            <TutorialProvider>
              ...
              <ErrorBoundary>
                ...
                <Routes>
                  ...
                  <Route path="/internal/totp-render-frame" element={<TotpRenderFrame />} />
                  ...
                  <Route element={<Layout />}>
                    ...
                    <Route path={festivalRoutePatterns.edition} element={<FestivalEditionShell />}>
                      ...
                      <Route path={festivalRoutePatterns.launch.split("/").at(-1)} element={<FestivalEditionWorkspace section="launch" />} />
                    ...
                    <Route path="social/contracts" element={<SocialHubUnified />} />
