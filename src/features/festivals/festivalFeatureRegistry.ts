...
export const festivalFeatureRegistry: FestivalFeatureRegistryEntry[] = [
  ...
  ["slots","Slots","Generate, preview and maintain safe stage slots.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Stages","stage_manager",["planning","applications_open","booking","setup"],"visible","stage resolved to edition","FestivalStageSlotTimeline","No slots generated yet.","Slot consistency validation failed."],
