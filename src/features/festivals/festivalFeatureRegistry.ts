...
export const festivalFeatureRegistry: FestivalFeatureRegistryEntry[] = [
  ...
  ["stages","Stages","Create, edit, archive stages and manage slots.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Stages","stage_manager",["planning","applications_open","booking","setup"],"visible","canonical RPC available","FestivalStageManagement","No stages yet; create a stage.","Stage RPC failed or legacy mapping unresolved."],
  ["slots","Slots","Generate, preview and maintain safe stage slots.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Stages","stage_manager",["planning","applications_open","booking","setup"],"visible","stage resolved to edition","FestivalStageSchedule","No slots generated yet.","Slot consistency validation failed."],
  ["staff","Staff","Requirements, candidates, hires, shifts and wages.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Staff","operations_manager",["planning","setup","live"],"visible","staff services available","FestivalStaffManagement","No staff hired yet.","Staff services failed."],
  ["permits","Permits","Owner application workflow and admin review state.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Permits","operations_manager",["planning","setup"],"visible","permit requirements loaded","FestivalPermitManagement","No permits required yet.","Permit service failed."],
  ["insurance","Insurance","Quotes, purchases, policies and stale quote warnings.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Insurance","finance_manager",["planning","setup"],"visible","quote RPC loaded","FestivalInsuranceManagement","No quotes yet.","Insurance service failed."],
  ["finance","Finance","Budget, costs, income, profit, blockers and currency warnings.",["owner","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Finance","finance_manager",owner,"visible","finance summary RPC loaded","FestivalFinanceManagement","No ledger entries yet.","Finance RPC failed."],
  ...
  ["outcomes","Outcomes","Owner, band and public outcome projections.",["owner","player","public","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Outcomes","festival_view",["settling","completed"],"read_only","outcomes exist","FestivalOutcomesManagement","Outcomes pending.","Outcomes failed to load."],
  ["settlement","Settlement","Readiness, progress, discrepancies and reports.",["owner","player","admin"],"/festivals/:festivalId/manage/editions/:editionId","Owner > Settlement","finance_manager",["settling","completed"],"visible","safe report RPC authorised","FestivalSettlementManagement","Settlement not prepared.","Settlement report unavailable."],
  ["legacy-records","Legacy records","Mapped game-event compatibility and repair evidence.",["admin"],"/admin/festivals","Admin > Legacy Records","admin",[],"read_only","admin legacy screen mounted","FestivalLegacyRecordsManagement","No legacy issues.","Legacy issues failed to load."],
  ["data-health","Data health","Migration blockers, currency/category issues and repairs.",["admin"],"/admin/festivals","Admin > Data Health","admin",[],"visible","migration issue table loaded","FestivalDataHealthManagement","No open blockers.","Data health failed to load."],
  ...
  ["audit-log","Audit log","Audited operational changes and repair actions.",["admin"],"/admin/festivals","Admin > Audit","admin",[],"read_only","audit screen mounted","FestivalAuditLog","No audit events yet.","Audit failed to load."],
