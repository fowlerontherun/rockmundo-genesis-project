...
export function PublicFestivalEditionPage() {
  ...
  return <main className="mx-auto max-w-5xl p-6"><nav aria-label="Breadcrumb"><Link to={festivalRoutes.publicCompany(q.data.publicSlug!)}>Festival company</Link> / Annual edition</nav><h1 className="text-3xl font-bold">Festival {q.data.editionYear}</h1><p>Public schedule and historical information for this annual edition.</p></main>;
}
