  ...
  return {
    ...
    payload: {
      ...
      song: {
        ...
        audioUrl: performance.audio?.extended_audio_url ?? performance.audio?.audio_url ?? null,
        audioGenerationStatus: performance.audio?.audio_generation_status ?? null,
        audioDurationSeconds: performance.audio?.duration_seconds ?? null,
      },
      stage,
      performanceDurationMs,
      totalDurationMs,
