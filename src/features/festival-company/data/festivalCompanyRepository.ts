...
const actionErrorCodes=["FESTIVAL_APPLICATION_NOT_FOUND","FESTIVAL_APPLICATION_ALREADY_EXISTS","FESTIVAL_APPLICATION_WINDOW_CLOSED","FESTIVAL_APPLICATION_DEADLINE_PASSED","FESTIVAL_APPLICATION_INVALID_TRANSITION","FESTIVAL_APPLICATION_VERSION_CONFLICT","FESTIVAL_APPLICATION_IDEMPOTENCY_CONFLICT","FESTIVAL_APPLICATION_ACCESS_DENIED","FESTIVAL_APPLICATION_ARTIST_INELIGIBLE","FESTIVAL_APPLICATION_INSUFFICIENT_SONGS","FESTIVAL_APPLICATION_GENRE_MISMATCH","FESTIVAL_APPLICATION_SCHEDULE_CONFLICT","FESTIVAL_APPLICATION_ALREADY_CONTRACTED","FESTIVAL_APPLICATION_EDITION_LOCKED","FESTIVAL_APPLICATION_EDITION_CANCELLED","FESTIVAL_APPLICATION_CAPACITY_REACHED","FESTIVAL_APPLICATION_BUDGET_UNAVAILABLE","FESTIVAL_INVITATION_NOT_FOUND","FESTIVAL_INVITATION_EXPIRED","FESTIVAL_INVITATION_ALREADY_RESPONDED","FESTIVAL_CONTRACT_CREATION_FAILED","festival_artist_action_forbidden","festival_artist_applications_closed","festival_artist_application_window_invalid","festival_artist_not_eligible","festival_artist_application_duplicate","festival_artist_already_booked","festival_artist_application_forbidden","festival_artist_invitation_duplicate","festival_artist_invitation_invalid_transition","festival_artist_application_invalid_transition","festival_artist_offer_invalid_transition","festival_artist_booking_invalid_transition","festival_artist_offer_budget_exceeded","festival_artist_offer_stale","festival_artist_idempotency_conflict"];
const actionError=(error:{message?:string})=>new Error(actionErrorCodes.find(x=>error.message?.includes(x))??"FESTIVAL_APPLICATION_UNAVAILABLE");
...
import {parseFestivalOperationsActionResult,parseFestivalStaffVacancies,parseFestivalSupplierOpportunities,type FestivalOperationsActionResult} from "../domain/festivalOperationsWorkflows";
