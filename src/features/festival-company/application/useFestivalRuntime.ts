...
export const useFestivalPerformanceSimulationJobs=(id:string)=>useQuery({queryKey:[...key(id),"simulation-jobs"],queryFn:()=>festivalRuntimeRepository.simulationJobs(id),enabled:Boolean(id),refetchInterval:5_000});
