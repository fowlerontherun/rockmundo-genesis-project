...
const FestivalCompanySetupPage = () => {
  ...
  return <FMPageScaffold title={setup.publicName} subtitle="Festival identity, site and stage planning" icon={Tent} backTo="/my-companies"><FestivalSetupSummary setup={setup} /><FestivalConfigurationWizard festivalCompanyId={festivalCompanyId} /><FestivalSitePlanner festivalCompanyId={festivalCompanyId} /></FMPageScaffold>;
};
