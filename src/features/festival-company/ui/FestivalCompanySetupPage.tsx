...
const FestivalCompanySetupPage = () => {
  ...
  return <FMPageScaffold title={setup.publicName} subtitle="Festival identity, site, stage and ticket planning" icon={Tent} backTo="/my-companies"><FestivalSetupSummary setup={setup} /><FestivalConfigurationWizard festivalCompanyId={festivalCompanyId} /><FestivalSitePlanner festivalCompanyId={festivalCompanyId} /><FestivalTicketPlanner festivalCompanyId={festivalCompanyId} /><FestivalArtistPlanner festivalCompanyId={festivalCompanyId} /></FMPageScaffold>;
};
