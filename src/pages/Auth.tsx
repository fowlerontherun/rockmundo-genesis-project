...
const Auth = () => {
 ...
 <Button
 variant="link"size="sm"className="text-muted-foreground hover:text-primary"onClick={() => navigate("/about")}
 >
 What is RockMundo?
 </Button>
 </div>
 ...
 size="sm"className="w-full border-border/60 bg-muted/60 text-foreground hover:bg-muted/80 hover:text-foreground"variant="outline">
 ...
 <Input
 id="new-password"type="password"placeholder="••••••••"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={newPassword}
 ...
 <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground"/>
 <Input
 id="confirm-password"type="password"placeholder="••••••••"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={confirmPassword}
 ...
 <Button
 type="submit"className="w-full h-11 bg-gradient-primary hover:shadow-electric font-oswald text-base tracking-wide transition-all duration-200"disabled={passwordUpdateLoading}
 >
 ...
 <Input
 id="login-email"type="email"placeholder="your@email.com"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={loginData.email}
 ...
 <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground"/>
 <Input
 id="login-password"type="password"placeholder="••••••••"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={loginData.password}
 ...
 <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground"/>
 <Input
 id="login-beta-code"type="text"placeholder="Enter your Beta code"autoComplete="off"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={loginData.betaCode}
 ...
 <Button
 type="submit"className="w-full h-11 bg-gradient-primary hover:shadow-electric font-oswald text-base tracking-wide transition-all duration-200"disabled={loading}
 >
 ...
 <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground"/>
 <Input
 id="signup-email"type="email"placeholder="your@email.com"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={signupData.email}
 ...
 <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground"/>
 <Input
 id="signup-password"type="password"placeholder="••••••••"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={signupData.password}
 ...
 <Checkbox
 id="terms"checked={termsAccepted}
 ...
 <Button
 type="submit"className="w-full h-11 bg-gradient-primary hover:shadow-electric font-oswald text-base tracking-wide transition-all duration-200 mt-4"disabled={loading || !termsAccepted}
 >
 ...
 <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground"/>
 <Input
 id="forgot-email"type="email"placeholder="your@email.com"className="pl-10 h-11 bg-input/80 border-border/50 focus:border-primary"value={forgotPasswordEmail}
 ...
 <Button
 type="submit"className="w-full h-11 bg-gradient-primary hover:shadow-electric font-oswald text-base tracking-wide transition-all duration-200"disabled={resetLinkLoading}
 >
 ...
 <button
 type="button"onClick={handleDiscordLinkClick}
