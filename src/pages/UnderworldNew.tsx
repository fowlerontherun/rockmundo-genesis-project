...
const PriceCell = ({ price, previousPrice }: { price: number; previousPrice?: number }) => {
 ...
 return (
 <span
 className={cn("font-mono transition-colors duration-300",
...
export const UnderworldContent = ({ tokens, tokensLoading }: { tokens: CryptoToken[]; tokensLoading: boolean }) => {
 ...
 return (
 <FMPageScaffold
 title="Underworld"subtitle="Shadow market for off-ledger deals"icon={Skull}
 backTo="/city"backLabel="Back to City"headerActions={
 ...
 <img
 src={underworldVeil}
 alt="Abstract neon fog"className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-40"loading="lazy"/>
 ...
 <span className="font-semibold tracking-wide">Underworld Nexus</span>
 </div>
 ...
 <div>
 <p className="text-sm tracking-wide text-primary">Shadow Store</p>
 ...
 <div>
 <p className="text-sm tracking-wide text-primary">District lore</p>
 ...
 <TableRow
 key={token.symbol}
 className={cn("cursor-pointer transition hover:bg-primary/5",
 ...
 <Input
 id="buy-quantity"type="number"inputMode="decimal"placeholder="0.00"value={buyQuantity}
 ...
 <Input
 id="sell-quantity"type="number"inputMode="decimal"placeholder="0.00"value={sellQuantity}
 ...
 <div>
 <p className="text-sm tracking-wide text-primary">Allies & exits</p>
