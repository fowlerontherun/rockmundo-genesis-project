...
export default function AwardShows() {
 ...
 return (
 <FMPageScaffold
 title="London Award Shows"subtitle={`Plan nomination campaigns, voting pushes, and performance narratives for ${stageIdentity}.`}
 icon={AwardIcon}
 ...
 <p className="text-xs tracking-wide text-primary/80">Focus: {category.focus}</p>
 ...
 <p className="mt-2 text-xs tracking-wide text-primary/80">Plan: Ensure check-in scans complete.</p>
 </div>
 <div className="rounded-lg border border-border/60 bg-muted/30 p-4 text-sm text-muted-foreground">
