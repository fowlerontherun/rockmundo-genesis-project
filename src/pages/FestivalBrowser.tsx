...
export default function FestivalBrowser() {
 ...
 return (
 <FMPageScaffold
 title="Festivals"subtitle="Perform, explore & grow your fanbase"icon={Music}
 ...
 <Card 
 key={festival.id} 
 className="group hover:border-primary/40 transition-all duration-200 cursor-pointer overflow-hidden"onClick={() => navigate(`/festivals/${festival.id}`)}
 >
 ...
 {!participation && band && (
 <Button
 size="sm"className="flex-1 h-8 text-xs"onClick={() => {
 ...
 <Button
 variant="outline"size="sm"className="flex-1 h-8 text-xs"onClick={() => withdrawFromFestival.mutate(participation.id)}
 ...
 {!band && (
 <Button
 variant="outline"size="sm"className="flex-1 h-8 text-xs"onClick={() => navigate("/band")}
 >
 Join a Band First
 </Button>
 )}
 ...
 <Button
 variant="outline"size="sm"className="mt-4"onClick={() => setActiveTab("browse")}
 >
 Browse Festivals
 </Button>
 </CardContent>
 ...
 className="hover:border-primary/40 transition-colors cursor-pointer"onClick={() => {
 ...
 <Button
 variant="outline"size="sm"className="mt-4"onClick={() => navigate("/band")}
 >
 Find a Band
 </Button>
 </CardContent>
