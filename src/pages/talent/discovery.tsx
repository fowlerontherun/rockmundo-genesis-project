...
const TalentDiscoveryPage = () => {
 ...
 return (
 <FMPageScaffold
 title="Talent Discovery & Auditions"subtitle="Find open casting calls, submit tailored materials, and track reviews from casting directors."icon={Sparkles}
 backTo="/hub/career"headerActions={
 profile ? (
 ...
 <Input
 id="search"placeholder="Vocals, sci-fi series, LA..."value={filters.searchTerm}
 ...
 <Input
 id="location"placeholder="City, country, or region"value={filters.location}
 ...
 <button
 key={call.id}
 type="button"onClick={() => setSelectedCallId(call.id)}
 className={cn("w-full rounded-lg border bg-background text-left transition hover:shadow-sm",
 ...
 name="castingCallRoleId"render={({ field }) => (
 <FormItem>
 ...
 <FormField
 control={submissionForm.control}
 name="coverLetter"render={({ field }) => (
 <FormItem>
 <FormLabel>Cover letter</FormLabel>
 <FormControl>
 <Textarea
 {...field}
 placeholder="Introduce yourself, share your motivation, and highlight why you're a great fit."rows={4}
 />
 </FormControl>
 <FormMessage />
 </FormItem>
 ...
 <FormField
 control={submissionForm.control}
 name="experienceSummary"render={({ field }) => (
 <FormItem>
 <FormLabel>Experience highlights</FormLabel>
 <FormControl>
 <Textarea
 {...field}
 placeholder="List relevant performances, training, or notable achievements."rows={4}
 />
 </FormControl>
 <FormMessage />
 </FormItem>
 ...
 <FormField
 control={submissionForm.control}
 name="portfolioUrl"render={({ field }) => (
 <FormItem>
 ...
 <FormField
 control={submissionForm.control}
 name="auditionVideoUrl"render={({ field }) => (
 ...
 target="_blank"rel="noreferrer"className="flex items-center gap-1 text-primary underline">
 ...
 <div>
 {isClosed
 ?"This casting call has closed.":"You can withdraw your submission while the call is open."}
 </div>
 <Button
 variant="outline"size="sm"disabled={withdrawMutation.isPending || isClosed}
 ...
 placeholder="Share context for your decision. Talent sees this when the review is published."rows={3}
 />
 </div>
 </div>
 </CardContent>
