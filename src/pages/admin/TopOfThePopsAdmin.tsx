...
function tabFromHash(hash: string): AdminTab | null {
  ...
  if (hash === "#bookings" || hash === "#totp-bookings") return "bookings";
...
function AdminTabsList() {
  return (
    <TabsList className="grid h-auto w-full grid-cols-2 gap-1 md:grid-cols-7">
      ...
      <TabsTrigger value="bookings" className="gap-1.5"><UserRoundPlus className="h-4 w-4" /> Bookings</TabsTrigger>
      ...
      <div className="mx-auto max-w-6xl space-y-6 p-4 md:p-6">
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as AdminTab)} className="space-y-4">
          ...
          <TabsContent value="bookings" className="space-y-4" id="bookings">
            <Card><CardContent className="p-6 text-sm text-muted-foreground">Schedule an episode before booking bands for Top of the Pops.</CardContent></Card>
          </TabsContent>
