...
const formatStationForPersistence = (station: StationFormState): StationFormState => ({
 ...
 city_id:
 station.station_type ==="local"? station.city_id && station.city_id !==""? station.city_id
 : null
 : null,
});
...
export default function RadioStations() {
 ...
 .select('*, songs(title, genre, band_id, hype, total_radio_plays, streams, revenue), radio_stations(name, listener_base), profiles(display_name)')
 ...
 placeholder="ROCK FM"aria-invalid={!!createStationErrors.name}
 />
 ...
 placeholder="USA"aria-invalid={!!createStationErrors.location}
 />
 ...
 <Input
 type="number"min="1"max="5"value={newStation.quality_level}
 onChange={(e) =>
 ...
 <Input
 type="number"value={newStation.listener_base}
 onChange={(e) =>
 ...
 <Button
 size="sm"variant="ghost"onClick={() => setEditingStation(station)}
 >
 <Edit2 className="h-4 w-4"/>
 </Button>
 <Button
 size="sm"variant="ghost"onClick={() => deleteStation.mutate(station.id)}
 >
 ...
 <span>
 {station.station_type ==='national'? station.country
 : station.cities?.name}
 </span>
 </div>
 <div className="flex justify-between text-sm">
 ...
 <form
 className="space-y-4"onSubmit={(e) => {
 e.preventDefault();
 ...
 country:
 editStationForm.station_type ==='national'? editStationForm.country
 : null,
 city_id:
 editStationForm.station_type ==='local'? editStationForm.city_id
 : null,
 };
 ...
 <Label>Quality Level (1-5)</Label>
 <Input
 type="number"min="1"max="5"value={editStationForm?.quality_level || 3}
 onChange={(e) =>
 editStationForm && setEditStationForm({
 ...editStationForm,
 ...
 <Label>Listener Base</Label>
 <Input
 type="number"value={editStationForm?.listener_base || 0}
 onChange={(e) =>
 editStationForm && setEditStationForm({
 ...editStationForm,
 ...
 <DialogFooter>
 <Button
 type="button"variant="outline"onClick={() => setEditingStation(null)}
 >
 Cancel
 </Button>
 ...
 <Button
 size="sm"onClick={() => approveSubmission.mutate(submission)}
 ...
 <Input
 type="number"step="0.1"min={MIN_LISTENER_MULTIPLIER}
 ...
 <div className="flex gap-1">
 <Button
 size="sm"variant="ghost"onClick={() => setEditingShow(show)}
 >
 <Edit2 className="h-4 w-4"/>
 </Button>
 <Button
 size="sm"variant="ghost"onClick={() => deleteShow.mutate(show.id)}
 >
 <Trash2 className="h-4 w-4"/>
 </Button>
 </div>
 ...
 placeholder="ROCK FM"aria-invalid={!!editStationErrors.name}
 />
 ...
 placeholder="USA"aria-invalid={!!editStationErrors.location}
 />
 ...
 <Label>Quality Level (1-5)</Label>
 <Input
 type="number"min="1"max="5"value={editStationForm.quality_level}
 onChange={(e) =>
 setEditStationForm({
 ...editStationForm,
 ...
 <Label>Listener Base</Label>
 <Input
 type="number"value={editStationForm.listener_base}
 onChange={(e) =>
 setEditStationForm({
 ...editStationForm,
