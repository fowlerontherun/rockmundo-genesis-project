...
function TeachingInner() {
 ...
 return (
 <FMPageScaffold
 title="Teaching"subtitle="Teach your skills to friends — both of you earn XP!"icon={GraduationCap}
 ...
 <Button
 variant="ghost"size="sm"className="text-destructive hover:text-destructive flex-shrink-0"disabled={cancellingId === session.id}
 >
 ...
 <>
 <p className="text-xs text-muted-foreground pt-2">Cancelled</p>
