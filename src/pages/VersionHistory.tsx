...
const versionHistory: VersionEntry[] = [
  {
    ...
    date: "2026-04-02",
    changes: [
      { type: 'bugfix', description: "Fixed song regeneration — retry now properly clears old audio URL so the generation engine accepts the request" },
      { type: 'bugfix', description: "Fixed regeneration button not appearing on failed songs that already had a previous audio file" },
