...
export default function WellnessPage() {
 ...
 return (
 <FMPageScaffold
 title="Wellness & Lifestyle"subtitle="Manage health, recovery, holidays, and addictions"icon={Heart}
 backTo="/hub/character"headerActions={
 ...
 className="w-full"variant={health <= 30 ?"destructive":"outline"}
 >
 ...
 <Button
 key={program}
 variant="outline"className="justify-start h-auto py-3 whitespace-normal overflow-visible"onClick={() => startRecovery({ addictionId: addiction.id, program })}
 ...
 <h3 className={`text-sm font-bold ${tierColor}`}>{tierLabel}</h3>
 ...
 <Button
 key={d}
 size="sm"variant={canAfford && canBookHoliday ?"default":"outline"}
 className="text-[11px] h-7 px-2"disabled={isBooking || !canBookHoliday || !canAfford}
