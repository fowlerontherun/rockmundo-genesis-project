...
const CompetitiveLeaderboards = () => {
 ...
 key={season.id}
 value={season.id}
 className={cn("rounded-full border px-4 py-2 text-sm",
 ...
 <>
 <SummaryMetric
 title="Total competitors"value={formatNumber(summary.totalPlayers)}
 description="Profiles tracked in this bracket"icon={Users}
 />
 <SummaryMetric
 title="Average score"value={formatNumber(Math.round(summary.averageScore))}
 description="Composite leaderboard rating"icon={TrendingUp}
 />
 <SummaryMetric
 title="Revenue generated"value={formatCurrency(Math.round(summary.totalRevenue))}
 description="Seasonal earnings across competitors"icon={Crown}
 />
 <SummaryMetric
 title="Achievements unlocked"value={formatNumber(summary.totalAchievements)}
 description="Total badges earned during the season"icon={Sparkles}
 />
 </>
 ) : (
 <SummaryMetric
 title="Total competitors"value="0"description="Profiles tracked in this bracket"icon={Users}
 />
 )}
 </div>
