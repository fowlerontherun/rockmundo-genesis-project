...
const MediaReputationPage = () => {
 ...
 return (
 <FMPageScaffold
 title="PR Command Center"subtitle="Track media activations, sentiment swings, and timeline commitments."icon={RadioTowerIcon}
 backTo="/hub/social"backLabel="Back to Social"headerActions={
 ...
 <div>
 <p className="text-xs tracking-wide text-muted-foreground">Trendline</p>
 ...
 />
 <YAxis
 yAxisId="earned"orientation="right"tickLine={false}
 axisLine={false}
 width={72}
 ...
 />
 <Area
 type="monotone"dataKey="score"yAxisId="score"stroke="var(--color-score)"strokeWidth={2}
 fill="url(#media-reputation)"activeDot={{ r: 4 }}
 />
 <Line
 type="monotone"dataKey="earnedMedia"yAxisId="earned"stroke="var(--color-earnedMedia)"strokeWidth={2}
 dot={false}
 />
 <Line
 type="monotone"dataKey="sentimentPercent"yAxisId="score"stroke="var(--color-sentimentPercent)"strokeDasharray="6 4"strokeWidth={2}
 dot={false}
 />
 </AreaChart>
 </ChartContainer>
 ...
 <div className="flex flex-wrap items-center justify-between gap-4">
 <div>
 <p className="text-xs tracking-wide text-muted-foreground">PR workload</p>
