...
export default function Radio() {
 ...
 <Button
 key={opt.value}
 size="sm"variant={filter === opt.value ?"default":"outline"}
 ...
 <Badge variant="secondary"className="">{activeStation.station_type}</Badge>
 </div>
 <div className="flex justify-between">
 <span className="text-muted-foreground">Location</span>
 <span className="flex items-center gap-1 text-xs">
 <MapPin className="h-3 w-3"/>
 {activeStation.station_type ==='national'? activeStation.country ||'International': `${activeStation.cities?.name ??'Unknown'}`
 }
 </span>
 </div>
 </CardContent>
