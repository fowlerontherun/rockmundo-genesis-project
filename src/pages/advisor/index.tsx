...
const AdvisorPage = () => {
 ...
 ?"Here's what I'm seeing in your numbers right now.":"No red alerts in the data—stay consistent and check back after your next update.";
 ...
 >
 <div
 className={cn("max-w-xl rounded-2xl border px-4 py-3 shadow-sm",
 message.role ==="advisor"?"border-primary/20 bg-background":"border-primary bg-primary text-primary-foreground",
 )}
 >
 ...
 variant="outline"className={cn("border", getTrendBadgeClasses(metric.trend))}
 >
 ...
 placeholder="Ask the advisor what to focus on next…"className="min-h-[90px] resize-none"/>
