      ...
      <Dialog open={betaOpen} onOpenChange={setBetaOpen}>
        <DialogContent className="sm:max-w-md bg-card/95 backdrop-blur-sm border-border/40">
          <DialogHeader>
            ...
            <DialogDescription className="font-oswald">
              Beta V1 has finished. Beta V2 launches in August — drop your email
              and we'll send your access code before launch. Join the{""}
              <a
                href={DISCORD_URL}
                target="_blank"
          ...
          {betaDone ? (
            <div className="space-y-3 py-2 text-center">
              ...
              <p className="text-sm text-muted-foreground font-oswald">
                We'll email your Beta V2 access code to{" "}
                <span className="text-foreground">{betaEmail}</span> before
                launch.
              </p>
              <DialogFooter>
                <Button
                  className="font-oswald tracking-wide w-full"
