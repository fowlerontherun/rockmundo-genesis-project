  ...
  return (
    <CategoryHub
      ...
      tiles={[
        ...
        { icon: Handshake, labelKey: "Support Opportunities", path: "/advanced-gigs", description: "Advertise support availability, review offers, and build your support-band reputation.", imagePrompt: "Two touring rock bands shaking hands backstage before a support slot, venue posters and road cases nearby" },
