  ...
  return (
    <CategoryHub
      ...
      tiles={[
        ...
        { icon: ShoppingBag, labelKey: "In-Game Market", path: "/song-market", tileImageKey: "in-game-market", imagePrompt: "A bustling indoor marketplace bazaar with stalls selling musical gear, vintage clothes, rare books and mysterious items" },
      ]}
    />
  );
}
