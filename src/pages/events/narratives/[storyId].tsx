...
const NarrativeStoryPage = () => {
 ...
 <Badge key={tag} variant="secondary"className="text-[10px] tracking-wide">
 {tag}
 </Badge>
 ))}
 </div>
 ...
 {currentNode.endingType ==="success"?"Triumphant ending": currentNode.endingType ==="failure"?"Hard lesson":"Quiet resolution"}
 </Badge>
 )}
 </CardContent>
 </Card>
