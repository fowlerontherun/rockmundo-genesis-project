...
const EventBuilderPage = () => {
 ...
 <Input
 id="event-name"value={eventDetails.name}
 ...
 <Input
 id="event-id"value={eventDetails.eventId}
 onChange={(event) => setEventDetails((prev) => ({ ...prev, eventId: event.target.value }))}
 placeholder="evt_2025_summit"/>
 <Button
 type="button"variant="outline"onClick={() => setEventDetails((prev) => ({ ...prev, eventId: generateId() }))}
 >
 Generate
 </Button>
 </div>
 ...
 <Input
 id="event-date"type="date"value={eventDetails.date}
 ...
 <Input
 id="event-venue"value={eventDetails.venue}
 ...
 <Input
 id="event-capacity"type="number"min={0}
 ...
 <Input
 id="event-theme"value={eventDetails.theme}
 ...
 <Textarea
 id="event-description"value={eventDetails.description}
 onChange={(event) => setEventDetails((prev) => ({ ...prev, description: event.target.value }))}
 placeholder="A waterfront takeover blending immersive art, next-gen production, and global bass pioneers."rows={4}
 />
 </div>
 </div>
 ...
 <p className="text-xs text-muted-foreground">Lineup readiness</p>
 ...
 <div className="rounded-lg border p-3">
 <p className="text-xs text-muted-foreground">Sponsor traction</p>
 ...
 <div className="rounded-lg border p-3">
 <p className="text-xs text-muted-foreground">Ticket architecture</p>
 ...
 return (
 <FMPageScaffold
 title="Event builder"subtitle="Build a multi-day experience with a single workflow tying together lineup design, monetization, and analytics."icon={CalendarDays}
 backTo="/hub/events"headerActions={
 ...
 className="w-full justify-start text-left"onClick={() => setCurrentStep(index)}
 >
 ...
 <Button
 variant="ghost"onClick={() => setCurrentStep((prev) => Math.max(0, prev - 1))}
