...
export default function PropertyHub() {
  ...
  return <FMPageScaffold title="Property Hub" subtitle="Browse persistent real estate and start secure mortgage journeys." icon={Building2} backTo="/finances">
    ...
    <Card className="mt-6"><CardHeader><CardTitle className="flex items-center gap-2"><Banknote className="h-5 w-5" /> Mortgage dashboard</CardTitle><CardDescription>Phase 8B no longer manufactures a mortgage on page load. Active contracts now appear after the trusted completion RPC reserves the property, posts ledger-backed completion and registers lender security.</CardDescription></CardHeader><CardContent><div className="rounded-lg border border-dashed p-4 text-sm text-muted-foreground">No demo mortgage was created. Use the application flow to create a persistent application, immutable offer, reservation and contract.</div></CardContent></Card>
