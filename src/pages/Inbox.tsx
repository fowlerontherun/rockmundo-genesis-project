...
export default function InboxPage() {
 ...
 return (
 <FMPageScaffold
 title="Inbox"subtitle={hasUnread ? `${unreadCount} unread message${unreadCount !== 1 ?'s':''}` : undefined}
 backTo="/dashboard"backLabel="Back to Dashboard"icon={InboxIcon}
 headerActions={
 hasUnread ? (
 <Button
 variant="outline"size="sm"onClick={() => markAllAsRead()}
 className="gap-2">
