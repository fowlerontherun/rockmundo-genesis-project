...
import { Crown, Check, Zap, Building2, Radio, Users, Sparkles, Loader2, Music, Mic2, MapPin, Heart, Trophy, MessageSquare, Store, Shield, Volume2, Car } from "lucide-react";
...
const VIP_TIERS: Record<string, VipTier> = {
  monthly: {
    ...
    monthsCovered: 1,
    priceId: "price_1UBELBAzic6whdusjOCsQbdF",
    productId: "prod_VBbXz66OPT2U0y",
    period: "per month",
    savings: null,
  },
  quarterly: {
    ...
    monthsCovered: 3,
    priceId: "price_1UBERSAzic6whdusO8BLmZKr",
    productId: "prod_VBbXz66OPT2U0y",
  ...
  annual: {
    ...
    monthsCovered: 12,
    priceId: "price_1UBERxAzic6whdusmQfyWRKO",
    productId: "prod_VBbXz66OPT2U0y",
    period: "per year",
    savings: "33% off",
    popular: true,
            ...
            <CardContent className="space-y-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-sm">
                  ...
                  <span>All 13+ VIP features included</span>
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <Check className="h-4 w-4 text-green-500 shrink-0" />
                ...
                <li className="flex items-center gap-2 text-sm">
                  <Check className="h-4 w-4 text-green-500 shrink-0" />
                  <span>Automatic limo & private jet gig travel</span>
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <Check className="h-4 w-4 text-green-500 shrink-0" />
