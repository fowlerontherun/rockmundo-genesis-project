...
const ExperimentsAnalytics = () => {
 ...
 return (
 <FMPageScaffold
 title="Campaign Experiments Lab"subtitle="Compare creative variants, measure lift in your most important metrics, and ship the messages that keep fans coming back."icon={BarChart3}
 ...
 <p className="text-xs tracking-wide text-muted-foreground">Timeline</p>
 ...
 <p className="text-xs tracking-wide text-muted-foreground">Why it matters</p>
 <p className="text-sm text-muted-foreground">
 ...
 <p className="text-xs tracking-wide text-muted-foreground">Secondary goals</p>
 <p className="text-sm text-muted-foreground">
 ...
 <XAxis
 dataKey="date"tickFormatter={(value) =>
 ...
 <Line
 key={variant.id}
 type="monotone"dataKey={variant.id}
 name={variant.name}
 ...
 <YAxis
 yAxisId="right"orientation="right"tickFormatter={(value) => `$${value}k`}
 className="text-xs"/>
 <Tooltip
