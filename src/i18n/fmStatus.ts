...
const COPY: Record<SupportedLanguage, { cash: string; fame: string; health: string; energy: string; locale: string }> = {
  ...
  es: { cash: 'Dinero', fame: 'Fama', health: 'Salud', energy: 'Energía', locale: 'es-ES' },
  zh: { cash: '现金', fame: '知名度', health: '健康', energy: '精力', locale: 'zh-CN' },
  ...
  de: { cash: 'Geld', fame: 'Ruhm', health: 'Gesundheit', energy: 'Energie', locale: 'de-DE' },
